        ...
        <div class="body d-md-flex align-items-center justify-content-between">
            ...
            <div class=" box-2 d-flex flex-column h-100">
                <div class="mt-5">
                    ...
                    <br><br>
                    <button type="submit" class="btn btn-flat accent" value="Login">Log In</button>
                    <br><br>                   
                    </form>
                    <div class="mt-3">
                        <p class="mb-0 text-muted">Do not have an account?</p>
                        <button type="button" onclick="window.location.href='../main_controller/create'" class="btn btn-flat accent" value="Create">Create account</button>
                    </div>
                </div>
                <div class="mt-auto">
